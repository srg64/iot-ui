sap.ui.define([
	...
	return BaseObject.extend("de.asr.iot.ui5.iotui.model.GroupSortState", {
		 ...
		 * @alias de.asr.iot.ui5.iotui.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "Id") {
				...
				this._oViewModel.setProperty("/sortBy", "SensorName");
			}
