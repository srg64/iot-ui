sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("de/asr/iot/ui5/iotui/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("de.asr.iot.ui5.iotui.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["de/asr/iot/ui5/iotui/localService/mockserver"], function (mockserver) {
