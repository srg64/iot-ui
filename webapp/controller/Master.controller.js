/*global history */
sap.ui.define([
		"de/asr/iot/ui5/iotui/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"de/asr/iot/ui5/iotui/model/formatter",
		"de/asr/iot/ui5/iotui/model/grouper",
		...
		return BaseController.extend("de.asr.iot.ui5.iotui.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("SensorName", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("de.asr.iot.ui5.iotui.view.ViewSettingsDialog", this);
